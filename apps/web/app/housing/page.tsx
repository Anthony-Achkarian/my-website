...
export default function HousingPage() {
  ...
  const handleNotify = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = `mailto:anthonyachkarian@gmail.com?subject=Notify Me: ARK Housing&body=Please add me to the early access list for ARK Industries Housing Construction division.%0A%0AEmail: ${email}`;
    setSubmitted(true);
  };
  ...
  return (
    <main style={{ background: "var(--navy)", minHeight: "100vh" }}>
      ...
      <section className="cs-hero">
        <div className="cs-hero-bg" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1920&q=80')" }} />
        <div className="cs-hero-overlay" />
        <div className="cs-hero-content fade-up">
          <div className="hero-badge">Coming Soon — ARK Housing</div>
          <h1>Housing<br /><span className="gradient-text">Constructed.</span></h1>
          <p>The housing crisis is a technology problem. ARK Housing is solving it with AI-designed floor plans, robotics-assisted construction, and smart home systems built from the ground up — delivering better homes faster and at lower cost.</p>
          {!submitted ? (
      ...
      <section style={{ padding: "7rem 2rem", background: "var(--navy-light)", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div className="container">
          <div className="fade-up" style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            <div className="section-title">Building the Homes of Tomorrow.</div>
            <p className="section-sub" style={{ margin: "0 auto" }}>We believe everyone deserves a home designed by intelligence and built with precision. ARK is deploying AI and robotics across the full construction stack — from blueprint to building.</p>
          </div>
          <div className="cs-pillars fade-up">
            <div className="cs-pillar">
              ...
              <h3>AI-Designed Spaces</h3>
              <p>Generative design systems that optimize floor plans, natural light, energy efficiency, and structural integrity simultaneously — producing homes that are beautiful, efficient, and built to last.</p>
            </div>
            <div className="cs-pillar">
              <div className="cs-pillar-icon">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
              </div>
              <h3>Robotics-Assisted Construction</h3>
              <p>ARK robotic systems handle the repetitive, hazardous, and precision-demanding tasks on-site — cutting construction timelines by up to 60% while improving structural quality and reducing waste.</p>
            </div>
            <div className="cs-pillar">
              <div className="cs-pillar-icon">
              ...
              <p>Every ARK-built home ships with native AI automation — climate, security, energy management, and maintenance prediction built into the structure itself, not bolted on after the fact.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "7rem 2rem", textAlign: "center" }}>
        <div className="fade-up" style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <p style={{ color: "var(--gray-400)", fontSize: "1.05rem", lineHeight: 1.7, marginBottom: "2rem" }}>
            Developers, municipalities, and landowners interested in ARK Housing partnerships can apply now. Our first developments are planned for high-demand metros starting in 2027.
          </p>
          <a href="mailto:anthonyachkarian@gmail.com?subject=Notify Me: ARK Housing%20%E2%80%94%20Partnership%20Inquiry" className="btn-primary" style={{ display: "inline-flex" }}>
